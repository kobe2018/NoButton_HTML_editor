...
function function_company_web_seach(prog_input){
    ...
    //if(prog_input.match("ハイパー支援")) { window.location.href  = 'http://mpc000055824:8080/menteG2/';} // 新しいタブを開き、ページを表示
    //if(prog_input.match("根拠ツリー")) { window.location.href  ='http://mpc000055824:8080/menteG/'} // 新しいタブを開き、ページを表示
